...
public class Valuemodifier {
	...
	public static void main(String[] args) {
		...
		Consumer<String> c = s-> System.out.println("After converting string to uppercase:"+s.toUpperCase());
		Consumer<Integer> c1= s1-> System.out.println("Squares the integer value and prints it."+s1*s1);
