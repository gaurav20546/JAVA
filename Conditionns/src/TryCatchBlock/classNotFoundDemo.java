...
public class classNotFoundDemo 
{
	public classNotFoundDemo(String className)
	{
		...
		try {
			 ...
			 System.out.println("class load succusfully");
		}
		catch(Exception e)
		{
			System.err.println(className+" class file not found ");
	...
	public static void main(String[] args) {
		...
		classNotFoundDemo s=new classNotFoundDemo(str);
		sc.close();
	}
...
Objective:
Write a Java program that demonstrates how to handle ClassNotFoundException. The program should prompt the user to enter a
class name and attempt to load that class using reflection. If the class does not exist, the program should catch the exception and
...
java.lang.ClassNotFoundException: NonExistentClass
    ...
    at ClassNotFoundExpDemo.<int>(ClassNotFoundExpDemo.java:8)
