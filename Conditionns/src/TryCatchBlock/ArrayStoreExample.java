...
public class ArrayStoreExample {
	...
	public static void storeObjects()
	{
		...
		stringArray[0]="gaurav";
		stringArray[1]=123;
		stringArray[2]=true;
		stringArray[3]="gaurav";
		stringArray[4]="rram";
		...
		try {
			for(Object object:stringArray) {
				if(!(object instanceof String))
					throw new ArrayStoreException("Not a string type");
			}
			System.out.println("object Strore succusfully !");
		} catch(ArrayStoreException e)
		{
			System.err.println(e+"java.lang.Integer cannot be stored in an array of java.lang.String");
